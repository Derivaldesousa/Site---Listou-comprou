...
<body>
  ...
  <div class="login-container">
    ...
    <div class="signup-button"><a href="cadastrar_usuario.php">Ainda não tem uma conta? Cadastre-se</a></div>
  </div>
</body>
...
<script>
    window.addEventListener('DOMContentLoaded', (event) => {
        ...
        if (message === 'error') {
            ...
            popup.innerHTML = 'Dados incorretos';
    ...
    window.addEventListener('DOMContentLoaded', (event) => {
        ...
        if (message === 'success') {
            ...
            popup.innerHTML = 'Login efetuado com sucesso';
